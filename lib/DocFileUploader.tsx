...
const DocFileUploader: React.FC<FileUploaderProps> = ({ 
  ...
  const validateFile = (file: File): string | null => {
    ...
    if (!Object.keys(allowedFileTypes).includes(file.type)) {
      return 'Only CV (PDF, DOC, DOCX) and Excel (XLS, XLSX, CSV) files are allowed';
    }
        ...
        {uploadStatus === 'uploading' ? (
          ...
          <>
            ...
            <p className="requirements">
              Maximum file size: {maxSizeMB}MB. Supported formats: PDF, DOC, DOCX, XLS, XLSX, CSV
            </p>
            <input
              id="file-input"
              type="file"
            ...
            {files.map((file, index) => (
              <div key={index} className="file-preview">
                ...
                <div className="file-info">
                  ...
                  <p className="file-type">{file.type.split('/').pop()?.toUpperCase()}</p>
                </div>
              </div>
            ))}
          </div>
...
export default DocFileUploader;