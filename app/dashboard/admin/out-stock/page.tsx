...
export default function OrdersPage() {
  ...
  const fetchInventory = async () => {
    ...
    const inventory = await axios.get("/api/inventory/out-stock");
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Manage all low stock products"
    >
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>All Low Stock</CardTitle>
                <CardDescription>All products running Out of Stock</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <DataTable
              ...
              printTitle="Products Running Out of Stock"
            />
          </CardContent>
        </Card>
      </div>
