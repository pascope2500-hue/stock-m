...
export default function OrdersPage() {
  ...
  const fetchInventory = async () => {
    ...
    const inventory = await axios.get("/api/inventory/expired");
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>All Expired Products</CardTitle>
                <CardDescription>All Expired products</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
